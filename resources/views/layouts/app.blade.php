...
<html>
<head>
    <title>Location a Travel Category Flat Bootstarp Responsive Website Template | Home :: w3layouts</title>
    <link href="{{ asset(null) }}/css/bootstrap.css" rel="stylesheet" type="text/css" media="all">
    <link href="{{ asset(null) }}/css/style.css" rel="stylesheet" type="text/css" media="all" />
    ...
    <script src="{{ asset(null) }}/js/jquery.min.js"></script>
    <script src="{{ asset(null) }}/js/jquery.easydropdown.js"></script>
    <!-- Mega Menu -->
    <link href="{{ asset(null) }}/css/megamenu.css" rel="stylesheet" type="text/css" media="all" />
    <script type="text/javascript" src="{{ asset(null) }}/js/megamenu.js"></script>
